...
$routes = [
    ...
    'admin/students/(\d+)' => 'api/admin/students.php',
    'admin/student-history/(\d+)/(\d+)' => 'api/admin/student-history.php',
    'admin/student/(\d+)' => 'api/admin/student.php',
    'admin/attempt-result/(\d+)' => 'api/admin/attempt-result.php',
